...
insert  into `dosis_item`(`id_item`,`id_dosis`,`id_transaksi`) values (255,6,1),(288,6,2),(255,6,3),(288,6,4),(255,6,5),(288,6,6),(257,4,7);
...
insert  into `item_transaksi_apotek`(`id_item_transaksi_apotek`,`id_transaksi`,`disetujui`,`hrg_satuan`,`jumlah`,`racikan`,`id_item`,`id_rekomendasi`,`total`) values (257,1,'y',11000,5,NULL,255,2,55000),(258,1,'y',1100,6,NULL,287,NULL,6600),(259,2,'y',11000,5,'y',288,2,55000),(260,3,'y',11000,5,NULL,255,2,55000),(261,3,'y',1100,6,NULL,287,NULL,6600),(262,4,'y',11000,5,'y',288,2,55000),(263,5,'y',11000,5,NULL,255,2,55000),(264,5,'y',1100,6,NULL,287,NULL,6600),(265,6,'y',11000,5,'y',288,2,55000);
...
insert  into `item_transaksi_lain`(`id_item_transaksi_lain`,`id_transaksi`,`hrg_satuan`,`jumlah`,`disetujui`,`id_item`,`id_rekomendasi`,`total`) values (1,7,11000,1,'t',257,5,11000),(2,7,44000,1,'t',278,NULL,44000),(3,8,7000,2,NULL,282,NULL,14000);
...
insert  into `item_transaksi_penunjang`(`id_item_transaksi_penunjang`,`id_transaksi`,`disetujui`,`hrg_satuan`,`jumlah`,`kesimpulan`,`nilai`,`id_item`,`id_rekomendasi`,`total`) values (3,9,'y',117875,1,'sakit',NULL,259,5,NULL),(4,9,'y',117875,NULL,NULL,NULL,285,NULL,NULL),(5,10,NULL,NULL,NULL,NULL,NULL,286,NULL,NULL),(6,11,'y',117875,1,'sakit',NULL,259,5,NULL),(7,11,'y',117875,NULL,NULL,NULL,285,NULL,NULL),(8,12,NULL,NULL,NULL,NULL,NULL,286,NULL,NULL);
...
insert  into `kategori_dokter`(`kat_dokter`,`kat_nama`) values (1,'dak'),(2,'spesialis'),(3,'rumah sakit'),(4,'laboratorium'),(5,'umum'),(6,'lainnya'),(7,'gigi');
...
insert  into `master_buku_besar`(`id_transaksi`,`buku_besar`) values (1,'123'),(2,'123'),(3,'123'),(4,'123'),(5,'123'),(6,'123'),(7,'123'),(8,'575'),(9,'123'),(10,'123'),(11,'123'),(12,'123');
...
insert  into `master_diagnosa`(`id_diagnosa`,`nama_diagnosa`,`jenis_penyakit`,`kelompok_penyakit`) values (86,'Otitis Externa','non degeneratif','penyakit');
...
insert  into `master_dokter`(`id_dokter`,`nama_dokter`,`langg_dokter`,`tarif_dokter`,`tarif_standar`,`gol_dokter`,`kat_dokter`) values (105,'dr INEZ',NULL,NULL,NULL,3,5),(106,'dokter',NULL,NULL,NULL,3,5),(107,'dr Satria',NULL,NULL,NULL,3,5),(109,'dr Maria bsr',NULL,NULL,NULL,1,2),(110,'hjjhhvj',NULL,NULL,NULL,1,2);
...
insert  into `master_karyawan`(`id_karyawan`,`nip`,`nama_karyawan`,`alamat`,`sex`,`telp`,`ttl`,`ap`,`status`,`kelas_kamar`,`id_rayon`,`id_bagian`,`tgl_lahir`) values (127,'6443643647','fgsgddfsgdfsgdsf',NULL,NULL,NULL,NULL,NULL,NULL,NULL,8,NULL,NULL),(128,'634','perda',NULL,NULL,NULL,NULL,NULL,NULL,NULL,8,NULL,NULL),(129,'46364436','Perdana Pipit',NULL,NULL,NULL,NULL,NULL,NULL,NULL,8,NULL,NULL),(131,'0765003','Perdana Pipit',NULL,NULL,NULL,NULL,NULL,NULL,NULL,8,NULL,NULL),(132,'54235235423','dfsafdsaf',NULL,NULL,NULL,NULL,NULL,NULL,NULL,8,NULL,NULL);
...
insert  into `master_rekomendasi`(`id_rekomendasi`,`nama_rekomendasi`) values (1,'Tidak Disertai Kelengkapan Administrasi'),(2,'Harga Obat'),(3,'Hasil laborat/penunjang'),(4,'Lain - lain'),(5,'Tarif Dokter'),(6,'Tarif Kamar'),(7,'Tarif Tindakan'),(8,'Tidak Ada Progress'),(9,'Tidak Sesuai Data Penanggung'),(10,'Tidak Sesuai dg Kesesuaian Terapi'),(11,'Tidak Sesuai dn Kompetensi'),(12,'');
...
insert  into `master_tertanggung`(`id_tertanggung`,`nama_tertanggung`,`sex`,`tgl_lahir`,`status`,`usia`,`ditanggung`,`id_karyawan`) values (169,'fasfasfsdsss',NULL,NULL,'suami',NULL,NULL,127),(170,'fdasfasfdsaf',NULL,NULL,'afasdf',NULL,NULL,128),(171,'Perdana Pipit',NULL,NULL,'ybs',NULL,NULL,129),(173,'Perdana Pipit',NULL,NULL,'ybs',NULL,NULL,131),(174,'fsdafdsafsa',NULL,NULL,NULL,NULL,NULL,132);
...
insert  into `transaksi`(`id_transaksi`,`tgl_transaksi`,`tgl_kunjungan`,`id_tertanggung`) values (1,'2012-12-11','2012-12-03',169),(2,'2012-12-11','2012-12-03',170),(3,'2012-12-11','2012-12-03',169),(4,'2012-12-11','2012-12-03',170),(5,'2012-12-11','2012-12-03',169),(6,'2012-12-11','2012-12-03',170),(7,'2012-12-12','2007-12-12',171),(8,'2012-12-12','2007-12-12',171),(9,'2005-12-12','2012-12-12',173),(10,'2005-12-12','2012-12-12',174),(11,'2005-12-12','2005-12-12',173),(12,'2005-12-12','2006-12-12',174);
...
insert  into `transaksi_apotek`(`id_transaksi`,`no_surat`,`no_bukti`,`no_dak`,`restitusi`,`id_rujukan`,`id_dokter`,`id_provider`) values (1,'','142334',NULL,'t',5,105,208),(2,'','',NULL,'y',5,106,230),(3,'43243','142334',NULL,'t',5,105,208),(4,'','',NULL,'y',5,106,230),(5,'43243','142334',NULL,'t',5,105,208),(6,'','',NULL,'y',5,106,230);
...
insert  into `transaksi_diagnosa`(`id_transaksi_diagnosa`,`id_transaksi`,`id_diagnosa`) values (681,1,86),(682,2,86),(683,3,86),(684,4,86),(685,5,86),(686,6,86),(687,7,86),(689,9,86),(690,11,86);
...
insert  into `transaksi_lain`(`id_transaksi`,`no_surat`,`no_bukti`,`restitusi`,`id_rujukan`,`id_dokter`,`id_provider`) values (7,'fvf23','rf23','y',5,107,210),(8,'5342','352','y',5,107,210);
...
insert  into `transaksi_penunjang`(`id_transaksi`,`no_surat`,`no_bukti`,`restitusi`,`id_provider`,`id_dokter`,`id_rujukan`) values (9,NULL,'rgr233','y',210,109,NULL),(10,NULL,NULL,'y',200,110,NULL),(11,NULL,'rgr233','y',210,109,NULL),(12,NULL,NULL,'y',200,110,NULL);
...
insert  into `user_mitra`(`user_id`,`id_mitra`) values (2,1),(6,1),(3,2),(7,2),(13,2);
...
insert  into `user_rayon`(`user_id`,`id_rayon`) values (9,1),(10,1),(11,8);
...
insert  into `user_wilayah`(`user_id`,`id_wilayah`) values (4,1),(8,1),(12,1),(14,1),(5,4);
...
/*Table structure for table `v_item_transaksi_gigi` */

DROP TABLE IF EXISTS `v_item_transaksi_gigi`;

/*!50001 DROP VIEW IF EXISTS `v_item_transaksi_gigi` */;
/*!50001 DROP TABLE IF EXISTS `v_item_transaksi_gigi` */;

/*!50001 CREATE TABLE  `v_item_transaksi_gigi`(
 `id_item_transaksi_gigi` int(11) ,
 `id_transaksi` int(11) ,
 `jenis_item` varchar(45) ,
 `nama_item` varchar(100) ,
...
/*View structure for view v_item_transaksi_gigi */

/*!50001 DROP TABLE IF EXISTS `v_item_transaksi_gigi` */;
/*!50001 DROP VIEW IF EXISTS `v_item_transaksi_gigi` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_item_transaksi_gigi` AS select `itg`.`id_item_transaksi_gigi` AS `id_item_transaksi_gigi`,`itg`.`id_transaksi` AS `id_transaksi`,`ji`.`jenis_item` AS `jenis_item`,`mi`.`nama_item` AS `nama_item`,`mi`.`harga_item` AS `harga_item`,`itg`.`hrg_satuan` AS `hrg_satuan`,`itg`.`jumlah` AS `jumlah`,(`itg`.`jumlah` * `itg`.`hrg_satuan`) AS `total`,((`mi`.`harga_item` * `itg`.`jumlah`) - (`itg`.`jumlah` * `itg`.`hrg_satuan`)) AS `selisih`,`itg`.`satuan` AS `satuan`,`itg`.`disetujui` AS `disetujui`,`mr`.`nama_rekomendasi` AS `nama_rekomendasi` from (((`item_transaksi_gigi` `itg` join `master_item` `mi` on((`mi`.`id_item` = `itg`.`id_item`))) join `jenis_item` `ji` on((`ji`.`idjns_item` = `mi`.`idjns_item`))) join `master_rekomendasi` `mr` on((`mr`.`id_rekomendasi` = `itg`.`id_rekomendasi`))) */;
