		...
		$(document).ready(function()
			{
				...
				jQuery("#listapotek")
                                .jqGrid('navButtonAdd','#pagerapotek',{caption:"Print",
				...
				//alert("BERHASIL ayo SEMANGAT kalahkan skripsi");
                                ...
                                .jqGrid('navButtonAdd','#pagerapotek',{caption:"Impor",
                                onClickButton:function()
                                {
                                //buat window
								$("#masterapotekimpor").dialog({
								...
								modal:true,
								open:function(){
								$("#masterapotekimpor").load("<?php echo base_url() ?>index.php/master/apotek/impor");
								},
								close:function(){
								$(this).dialog('destroy');
								}
