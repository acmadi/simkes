		...
		var idgriddiagnosa='#'+'<?php echo $idgriddiagnosa;?>';
			...
			{       
				...
				tes.jqGrid({
					...
					colNames: ['Id Transaksi','Jenis','Item','Jumlah','Hrg.Standar','Hrg.Satuan','Satuan','Nilai','Kesimpulan','Rekomendasi','Total'],
					colModel: [
				...
				tes.jqGrid('navGrid',idpagergriditem,{view:false,edit:false,add:false,del:false},{},{},{},{closeOnEscape:true,closeAfterSearch:false,multipleSearch:false, multipleGroup:false, showQuery:false,drag:true,showOnLoad:false,sopt:['cn'],resize:false,caption:'Cari Record', Find:'Cari', Reset:'Batalkan Pencarian'});
                                jQuery(idgriditem)
                                .jqGrid('navButtonAdd',idpagergriditem,{caption:"",buttonicon:"ui-icon-pencil",
                                onClickButton:function()
                                {
                                     $("#hasilapotekedititem").load("<?php echo base_url() ?>index.php/hasil/hasilapotek/edititem");
...
<div id="hasilapotekedititem"></div>