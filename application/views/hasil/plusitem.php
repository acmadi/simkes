    ...
    $(iddoses).autocomplete({
        ...
        function <?php echo $fungsiadditem;?>()
        {
            ...
            var jenis_tagihan=$('#jenis_tagihan').val(),
                ...
                racikan=$(idracikan).val(),
                disetujui=$(iddisetujui).val(),
                doses=$(iddoses).val(),
                rekomendasi=$(idrekomendasi).val();
            var isi;
            isi="&jenis_tagihan="+jenis_tagihan+"&kunjungan="+<?php echo $idtrans;?>+"&nama_tagihan="+nama_tagihan+"&id_item="+id_item+"&harga_standart="+harga_standart+"&harga_satuan="+harga_satuan;
            ...
            $.ajax({
               url : "<?php echo base_url(); ?>index.php/transaksi/<?php echo $modul;?>/simpanitem",
               data : isi,
               type: 'get',
               success: function(data){
                   if (data!=null){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table width="210">
                                                ...
                                                <tr>
                                                    <td>Racikan:</td>
                                                    <td><input type="text" name="<?php echo $idracikan;?>" id="<?php echo $idracikan;?>" /></td>
                                                </tr>
                                            </table>
                                        </td>
                                        <td>
