...
class M_view_hasilgigi extends CI_Model {
	function __construct() 
	{
        ...
        function countDiagnosa($id_transaksi)
        {
            ...
            $jumlah= $this->db->get('v_hasiltransaksigigi');
        ...
        {
            $this->db->where('id_transaksi',$id_transaksi);
            $jumlah= $this->db->get('v_detail_item_transaksigigi');
            return $jumlah->num_rows();
        }
        ...
        {
            $this->db->where('id_transaksi',$id_transaksi);
            return $jumlah= $this->db->get('v_detail_item_transaksigigi');
