...
class M_tran_gigi extends CI_Model {
    ...
    function simpan_transaksi_gigi($datanya)
    {
        return $this->db->insert('transaksi_gigi',$datanya);
    }
    ...
    {
        return $this->db->insert('item_transaksi_gigi',$data);
    }
    ...
    function count_transaksi($like, $id) 
    {
        $like != '' ? $this->db->like($like) : '';
        $this->db->where('id_transaksi',$id);
        return $this->db->count_all_results('v_item_transaksi_gigi');
    }    
    function get_transaksi($like, $sidx, $sord, $limit, $start, $kun) 
    {
        ...
        $this->db->where('id_transaksi', $kun);
        $this->db->order_by($sidx, $sord);
        return $this->db->get('v_item_transaksi_gigi', $limit, $start);
    }
    
    function delete_transaksi($id) 
    {
	$this->db->where('id_item_transaksi_gigi', $id);
	$this->db->delete('item_transaksi_gigi'); 
    }
