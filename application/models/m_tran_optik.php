...
class M_tran_optik extends CI_Model {
    ...
    function simpan_trans_apotek($datanya)
    {
        return $this->db->insert('master_kunjungan',$datanya);
    }
    ...
    function simpan_periksa_optik($data)
    {
        return $this->db->insert('periksa_optik',$data);
    }
    ...
    {
        return $this->db->insert('item_transaksi_optik',$data);
    }
    ...
    function count_transaksi($like, $id) 
    {
        $like != '' ? $this->db->like($like) : '';
        $this->db->where('id_transaksi',$id);
        return $this->db->count_all_results('v_item_transaksi_optik');
    }    
    function get_transaksi($like, $sidx, $sord, $limit, $start, $kun) 
    {
        ...
        $this->db->where('id_transaksi', $kun);
        $this->db->order_by($sidx, $sord);
        return $this->db->get('v_item_transaksi_optik', $limit, $start);
    }
    /*
    ...
    {
	$this->db->where('id_item_transaksi_optik', $id);
	$this->db->delete('item_transaksi_optik'); 
    }
    
    function delete_periksa($id) 
    {
	$this->db->where('id_periksa_optik', $id);
	$this->db->delete('periksa_optik'); 
    }
    
    function count_periksa($like, $id) 
    {
        $like != '' ? $this->db->like($like) : '';
        $this->db->where('id_transaksi',$id);
        return $this->db->count_all_results('periksa_optik');
    } 
    
    function get_periksa($like, $sidx, $sord, $limit, $start, $kun) 
    {
        $like != '' ? $this->db->like($like) : '';
        $this->db->where('id_transaksi', $kun);
        $this->db->order_by($sidx, $sord);
        return $this->db->get('periksa_optik', $limit, $start);
    }
    ...
    function simpan_transaksi_optik($datanya)
    {
        return $this->db->insert('transaksi_optik',$datanya);
    }
