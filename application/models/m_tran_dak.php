...
class M_tran_dak extends CI_Model {
    ...
    {
        $this->db->select('idjenis_kunjungan, nama_kunjungan');
        $query = $this->db->get('jenis_kunjungan');
        return $query->result_array();
    }
    ...
    function simpan_transaksi_dak($datanya)
    {
        return $this->db->insert('transaksi_dak',$datanya);
    }
    
    function simpan_transaksi_periksa($datanya)
    {
        return $this->db->insert('periksa_dak',$datanya);
    }
    ...
    {
        return $this->db->insert('item_transaksi_dak',$data);
    }
    ...
    function count_transaksi($like, $id) 
    {
         $like != '' ? $this->db->like($like) : '';
        $this->db->where('id_transaksi',$id);
        return $this->db->count_all_results('v_item_transaksi_dak');
    }    
    function get_transaksi($like, $sidx, $sord, $limit, $start, $kun) 
    {
        ...
        $this->db->where('id_transaksi', $kun);
        $this->db->order_by($sidx, $sord);
        return $this->db->get('v_item_transaksi_dak', $limit, $start);
    }
    
    function get_id_item_lain($id)
    {
        $this->db->select('id_item,id_transaksi');
        $this->db->where('id_item_transaksi_dak',$id);
        $query = $this->db->get('item_transaksi_dak');
        return $query;
    }
    ...
    {
	$this->db->where('id_item_transaksi_dak', $id);
	$this->db->delete('item_transaksi_dak'); 
    }
    ...
    function getIdjnskunjungan($keyword)
    {
        $this->db->select('idjenis_kunjungan');
        $this->db->like('nama_kunjungan',$keyword,'after');
        $query = $this->db->get('jenis_kunjungan');
        return $query->result_array();
    }
}