...
class M_view_hasillain extends CI_Model {
	function __construct() 
	{
        ...
        function countDiagnosa($id_transaksi)
        {
            ...
            $jumlah= $this->db->get('v_hasiltransaksilain');
        ...
        {
            $this->db->where('id_transaksi',$id_transaksi);
            $jumlah= $this->db->get('v_detail_item_transaksilain');
            return $jumlah->num_rows();
        }
        ...
        {
            $this->db->where('id_transaksi',$id_transaksi);
            return $jumlah= $this->db->get('v_detail_item_transaksilain');
