...
class M_view_hasillab extends CI_Model {
	function __construct() 
	{
        ...
        function countDiagnosa($id_transaksi)
        {
            ...
            $jumlah= $this->db->get('v_hasiltransaksilab');
        ...
        {
            $this->db->where('id_transaksi',$id_transaksi);
            $jumlah= $this->db->get('v_detail_item_transaksilab');
            return $jumlah->num_rows();
        }
        ...
        {
            $this->db->where('id_transaksi',$id_transaksi);
            return $jumlah= $this->db->get('v_detail_item_transaksilab');
