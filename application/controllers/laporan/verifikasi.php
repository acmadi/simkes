...
class Verifikasi extends CI_Controller {
    ...
    function index()
    {
	$this->load->view('laporan/verifikasi'); //Default di arahkan ke function grid
	...
	/*if ($_GET['_search'] == 'true')
	{
		...
		# End #
		//$searchField='nama_verifikasi';
                //$searchField='';
                //$searchString=$verifikasi;
                //$searchString='';
	...
	foreach($data1 as $line)
	{
            ...
            $responce->rows[$i]['cell'] = array($line->id_transaksi,$line->tgl_transaksi,$line->tgl_kunjungan,
                                ...
                                $line->nama_dokter,$line->biaya,$line->disetujui,$line->nama_rekomendasi);
            $i++;
	}
