...
class ObatBerlebih extends CI_Controller {
    ...
    function index()
    {
	$this->load->view('laporan/obatBerlebih'); //Default di arahkan ke function grid
	...
	/*if ($_GET['_search'] == 'true')
	{
		...
		# End #
		//$searchField='nama_obatBerlebih';
                //$searchField='';
                //$searchString=$obatBerlebih;
                //$searchString='';
	...
	foreach($data1 as $line)
	{
            ...
            $responce->rows[$i]['cell'] = array($line->id_transaksi,$line->tgl_transaksi,$line->tgl_kunjungan,
                                ...
                                $line->nama_dokter,$line->nama_item,$line->jumlah,$line->harga_item,$line->hrg_satuan,
				$line->nama_dosis,$line->selisih);
            $i++;
	}
