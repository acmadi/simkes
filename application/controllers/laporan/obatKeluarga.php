...
class ObatKeluarga extends CI_Controller {
    ...
    function index()
    {
	$this->load->view('laporan/obatKeluarga'); //Default di arahkan ke function grid
	...
	/*if ($_GET['_search'] == 'true')
	{
		...
		# End #
		//$searchField='nama_obatKeluarga';
                //$searchField='';
                //$searchString=$obatKeluarga;
                //$searchString='';
	...
	foreach($data1 as $line)
	{
			...
			$detail="<a href='$line->id_transaksi' class='detail_obat'><span class='ui-icon ui-icon-document'></span></a>";
            $responce->rows[$i]['cell'] = array($line->id_transaksi,$line->tgl_transaksi,$line->tgl_kunjungan,
                                ...
                                $line->nama_dokter,$line->biaya,$detail);
            $i++;
	}
