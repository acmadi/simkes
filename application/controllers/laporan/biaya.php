...
class Biaya extends CI_Controller {
    ...
    function index()
    {
	$this->load->view('laporan/biaya'); //Default di arahkan ke function grid
	...
	foreach($data1 as $line)
	{
            ...
            $responce->rows[$i]['cell'] = array('',$line->id_transaksi,$line->tgl_transaksi,$line->tgl_kunjungan,$line->buku_besar,
                                $line->nip,$line->nama_karyawan,$line->ap,$line->nama_tertanggung,$line->status,
                                $line->nama_dokter,$line->nama_item,$line->jumlah,$line->harga_item,$line->hrg_satuan,$line->selisih,$line->disetujui,$line->nama_rekomendasi);
            $i++;
	}
	...
	$tulis=$this->excel->setActiveSheetIndex(0);
        ...
        //$tulis->setCellValue('D1', "Buku Besar");
        ...
        //$tulis->setCellValue('K1', "Nama Item");
        $tulis->setCellValue('J1', "Biaya");
        $tulis->setCellValue('K1', "Disetujui");
        $tulis->setCellValue('L1', "Rekomendasi");
        ...
        foreach($data1 as $line)
	{
            ...
            //$tulis->setCellValue('D'.$i, $line->buku_besar);
            ...
            $tulis->setCellValue('K'.$i, $line->disetujui);
            $tulis->setCellValue('L'.$i, $line->nama_rekomendasi);
