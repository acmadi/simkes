...
class LebihHet extends CI_Controller {
    ...
    function index()
    {
	$this->load->view('laporan/lebihHet'); //Default di arahkan ke function grid
	...
	/*if ($_GET['_search'] == 'true')
	{
		...
		# End #
		//$searchField='nama_lebihHet';
                //$searchField='';
                //$searchString=$lebihHet;
                //$searchString='';
	...
	foreach($data1 as $line)
	{
            ...
            $responce->rows[$i]['cell'] = array($line->id_transaksi,$line->tgl_transaksi,$line->tgl_kunjungan,
                                ...
                                $line->nama_provider,$line->rawat,$line->nama_item,$line->jumlah,$line->het,
                                $line->hrg_satuan,$line->selisih);
            $i++;
	}
